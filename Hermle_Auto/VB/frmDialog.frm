...
Dim header(80) As String
Dim maintext(80) As String
Dim solution(80) As String
...
Private Sub DefineHeader()
    ...
    header(11) = "Pocket to Pocket"
    header(12) = "Test All Pockets"
    ...
    header(21) = "Delete Work Piece"
    header(22) = "Add Work Piece"
    header(23) = "Change Priority"
    header(30) = "Start Application"
    header(31) = "Start Automat cycle"
    ...
    header(42) = "unload a full pocket in the first time"
    header(43) = "find an machined pocket to unload"
    header(44) = "Automatic operation"
    ...
    header(68) = "Release Emergency Stop."
    header(69) = "Pocket Status is Wrong."
    header(70) = "Kiosk To Pocket."
...
Private Sub DefineMainText()
    ...
    maintext(57) = "can not operate output.key not in remote mode or communication error"
    ...
    maintext(68) = "can not set power on."
    maintext(69) = "Pocket status is wrong .robot can not Take/Place tool."
...
Private Sub DefineSolution()
    ...
    solution(57) = "check key position,robot alarm,communication error."
    ...
    solution(67) = "check pocket status and serch agian."
    solution(68) = "check communication problem,door/window might be open or key position."
    solution(69) = "Check if tool exist in pocket "
...
Public Function ShowDialogForm _
    ...
    FrmDialog.LabelHeader.Caption = header(Myheader) ''need once !  do not erase !
    FrmDialog.LabelHeader.Caption = header(Myheader) ''need twice!  do not erase!
    FrmDialog.TextMain.Caption = maintext(MyTextMain)
